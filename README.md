...
└── prompts/
    ...
    ├── sql_agent.txt                   Промпт для SQL агента
    └── writer.txt                      Промпт для ответа модели
```
...
Создай файл .env в корне проекта:
    ...
    # Embeddings — переключаем на локальную модель
...
- Гибридный поиск — объединить векторный и BM25 поиск
...
- Реализовать GET /api/v1/avto — список объявлений с фильтрацией
"""
